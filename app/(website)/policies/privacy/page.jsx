  ...
  return (
    <div className="mt-10 md:mt-12 py-5 md:py-8 px-6 md:px-12">
      ...
      <div className="px-2">
        ...
        <p className="my-3">
          SHUBHAM KUMAR may change this Policy periodically and we urge you to
        ...
        <p className="my-3">
          <span className="font-semibold">Note:</span> Notwithstanding anything
        ...
        <p className="my-3">We may share your information or data with:</p>
        <ul className="list-disc ml-4">
          <li>
        ...
        <p className="mt-3">
          <span className="font-semibold">Right to Review</span> - You can
        ...
        <p className="mb-3">
          <span className="font-semibold">Withdrawal of your Consent</span> -
          ...
          us earlier, in writing to our email ID: tbkumarshubham@gmail.comIn the
        ...
        <h1 className="font-semibold text-xl my-3">Data Security</h1>
        <p className="my-3">
